...
char amd10h_events[16][64]={
  ...
  "L1_DTLB_AND_L2_DTLB_MISS:ALL",    /* PAPI_TLB_DM  */
...
char nehalem_events[16][64]={
  ...
  "ILD_STALL:ANY", // "HW_INT:RCV",                   /* PAPI_HW_INT  */
...
int main(int argc, char **argv) {
   ...
   if ( retval != PAPI_OK ) {
     fprintf(stderr,"ERROR: PAPImultiplex_init %d\n", retval);
   }
   ...
   if (retval!=PAPI_OK) {
     fprintf(stderr,"PAPI_set_multiplex failed\n");
   }
